...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        'flex min-h-16 w-full flex-row rounded-md border border-input bg-transparent px-3 py-2 text-base text-foreground shadow-sm shadow-secondary/10 dark:bg-input/30 md:text-sm',
        Platform.select({
